...
let pangaeaContinents: FeatureCollection = {
    ...
    "features": [{
        ...
        geometry: {
            ...
            coordinates: [
                [
                   [-13,86.67],[-10.33,86.67],[-7,86.33],[-3.67,86.67],
